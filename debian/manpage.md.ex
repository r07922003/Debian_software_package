...
**hello** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
...
:   The system-wide configuration file to control the behaviour of
    hello. See **foo.conf**(5) for further details.
...
**hello** provides some return codes, that can be used in scripts:
...
Nelson <nealson840123@gmail.com>
